...
https://github.com/lightbend/akkaserverless-python-sdk/tree/main/samples/js-customer-registry[The `akkaserverless-python-sdk` GitHub repository] includes an example of all views described on this page.
[#value-entity]
...
----
include::example$python-customer-registry/customer_domain.proto[tags=declarations;domain]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_view.proto[tags=declarations;service]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_view.proto[tag=unary]
----
...
.customer_value_entity_view.py
[source,js,indent=0]
----
include::example$python-customer-registry/customer_value_entity_view.py[tag=register]
----
...
[source,js,indent=0]
----
include::example$python-customer-registry/index.py[tag=register]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_domain.proto[tags=declarations;events]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_view.proto[tags=declarations;service-event-sourced]
----
...
.customer_eventsourced_view.py
[source,js,indent=0]
----
include::example$python-customer-registry/customer_eventsourced_view.py[tag=process-events]
----

<1> Each update method in the Protobuf definition should have a corresponding Python function in `view.setUpdateHandlers`.
...
[source,js,indent=0]
----
include::example$python-customer-registry/customer_eventsourced_view.py[tag=register]
----
...
[source,js,indent=0]
----
include::example$python-customer-registry/index.py[tags=register-event-sourced]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_view.proto[tags=declarations;service-topic]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_view.proto[tags=declarations;summary]
----
...
[source,proto,indent=0]
----
include::example$python-customer-registry/customer_view.proto[tag=wrap-repeated]
----
