...
IMPORTANT: This is a feature that needs to be added to the SDK.
...
[source,js,indent=0]
----
include::example$python-customer-registry/customer_eventsourced_entity_view.py[tag=register]
----
