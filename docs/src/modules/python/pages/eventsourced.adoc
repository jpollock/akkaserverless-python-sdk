...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=entity-class]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=lookup-type]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=initial]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=get-cart]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=add-item]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=item-added]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/shoppingcart.py[tag=behavior]
----
...
[source,js,indent=0]
----
include::example$python-eventsourced-shopping-cart/index.py[tag=add-entity]
----
