...
[source, proto]
----
include::example$python-eventsourced-shopping-cart/shoppingcart_domain.proto[tag=proto_state]
----
--
Value Entity::
+
...
[source, proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_domain.proto[tag=proto_state]
----
--
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_api.proto[tag=proto_syntax]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_api.proto[tag=proto_imports]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_api.proto[tag=proto_package]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_api.proto[tag=proto_messages]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_api.proto[tag=proto_service]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_domain.proto[tag=proto_syntax]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_domain.proto[tag=proto_imports]
----
...
[source,proto]
----
include::example$python-valueentity-shopping-cart/shoppingcart_domain.proto[tag=proto_messages]
----
