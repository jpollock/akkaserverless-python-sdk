...
// tag::entity-class[]
const ValueEntity = require("@lightbend/akkaserverless-python-sdk").ValueEntity;
...
describe("The ValueEntity class", () => {
  it("should allow adding the entity to the AkkaServerless server", () => {
    // tag::add-component[]
    const AkkaServerless = require("@lightbend/akkaserverless-python-sdk").AkkaServerless;
